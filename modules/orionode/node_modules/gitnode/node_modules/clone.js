...
/**
 * Produces whole 'wants' request needed to clone
 * @param serverDisc data obtained about server
 * @param start with wich want we start (default 0)
 * @param num how many objects do we want to iterate through and if we can 'want'
 * them, they will be addet to command (default 32, somewhat similar to native git)
 ...
 * @param callback(arrayOfPacks) where to pass the packs data
 */
var gitCloneConversation = function(gitProtoLink, callback)
{
    ...
    client.on('data', function(data){
        ...
        //            
                    ...
                    ans = [];
                    //console.log(cloneWant(sDiscovery).toString());
                    //TODO: MORE THAN 32 objects to clone:
                    //should iterate by 32 wants (check if want command isn't empty
                    //and send flush after the last one
