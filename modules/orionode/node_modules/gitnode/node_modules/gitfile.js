...
var saveFileDataAsBlob = function(data, repoPath, options)
{
    ...
    fileDataToSha1Store(data, function(err, sha1, store){
        ...
        checkSha1Path(sha1, repoPath, function(err, fileIsUnique){
            ...
            if(fileIsUnique)
            {
                deflateOptsToFile(store, getFilePath(sha1, repoPath), options);
            }
        });
    });
}
...
//exports.fileDataToSha1Store = fileDataToSha1Store;
//exports.fileToSha1Store = fileToSha1Store;
